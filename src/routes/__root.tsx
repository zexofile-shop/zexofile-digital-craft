...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zexofile Shop — Digital Files, Delivered" },
      { name: "description", content: "Premium digital assets — source codes, websites, apps and customizable digital services. Instant delivery, secure checkout." },
